 ...
 */
class getArticlesConseilsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArticlesConseilsRepository' shared autowired service.
     *
     * @return \App\Repository\ArticlesConseilsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArticlesConseilsRepository.php';

        return $container->privates['App\\Repository\\ArticlesConseilsRepository'] = new \App\Repository\ArticlesConseilsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
